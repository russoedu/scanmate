...
export default [
  {
    ...
    ignores: [
      ...
      'tmp/**',
      'playground-output/**',
      // Generated by `npm run parity:goldens` from the real TypeScript build,
      // never edited by hand. Linting them is pointless and, worse, they
      // legitimately contain U+2028 and U+2029: `JSON.stringify` leaves those
      // unescaped because JSON permits them in a string, while a JS or JSONC
      // parser reads them as line terminators and reports a multiline string.
      // The data is correct; the linter is the wrong tool for it.
      'tools/parity/goldens/**',
    ],
  },
